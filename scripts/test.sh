...
case "$1" in
    ...
    "build-nix")
        ...
        ;;
    "clippy")
        cargo clippy --profile dev --all-targets --all-features -p hyprshell -p hyprshell-config-lib -p hyprshell-core-lib -p hyprshell-exec-lib -p hyprshell-launcher-lib -p hyprshell-windows-lib -p hyprshell-hyprland-plugin -p hyprshell-clipboard-lib -- --deny warnings
        ;;
    "clippy-nix")
    ...
    "fmt-nix")
        ...
        ;;
    "test")
        cargo nextest run --cargo-profile dev --all-targets --all-features -p hyprshell -p hyprshell-config-lib -p hyprshell-core-lib -p hyprshell-exec-lib -p hyprshell-launcher-lib -p hyprshell-windows-lib -p hyprshell-hyprland-plugin -p hyprshell-clipboard-lib
        ;;
    "test-nix")
