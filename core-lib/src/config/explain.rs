...
pub fn explain(config: Config) -> String {
    ...
    if let Some(windows) = &config.windows {
        if let Some(overview) = &windows.overview {
            builder.push_str(&format!(
                "Use \x1b[1m\x1b[34m{} + {}\x1b[0m to open the Overview. Use \x1b[34mtab\x1b[0m and \x1b[34mgrave\x1b[0m/\x1b[34mshift + tab\x1b[0m to select a different window, press \x1b[34mreturn\x1b[0m to switch\n\
    ...
    if let Some(windows) = &config.windows {
        if let Some(switch) = &windows.switch {
            builder.push_str(&format!(
                "Press \x1b[1m\x1b[34m{} + tab\x1b[0m and hold \x1b[1m\x1b[34m{}\x1b[0m to view recently used applications. Press \x1b[34mtab\x1b[0m and \x1b[34mgrave\x1b[0m/\x1b[34mshift + tab\x1b[0m to select a different window,\n\
